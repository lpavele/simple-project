...
@Configuration
@EnableJpaRepositories(value="by.lpe.simple.repository")
...
public class InfrastructureConfig {
	...
	public DataSource dataSource() {
		...
		driverDataSource.setUrl("jdbc:postgresql://localhost:5432/simple");
	...
	public EntityManagerFactory  entityManagerFactory() {
		...
		factory.setPackagesToScan(getClass().getPackage().getName(),"by.ias.APIs.yandex.geo.objects");
